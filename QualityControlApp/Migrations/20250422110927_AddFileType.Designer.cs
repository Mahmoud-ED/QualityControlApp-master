...
namespace QualityControlApp.Migrations
{
    ...
    [Migration("20250422110927_AddFileType")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "18f63ac2-ca08-41ca-9dea-6c4e12fbbc89",
                            ConcurrencyStamp = "846548de-987a-4181-83e1-45e082c2e921",
                            Name = "Prog",
                            NormalizedName = "PROG"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "4b99c074-018e-4f27-a4dd-e02b372cc66f",
                            RoleId = "18f63ac2-ca08-41ca-9dea-6c4e12fbbc89"
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f16cc6be-98cb-4882-a162-59565024cd1d"),
                            Created = new DateTime(2025, 4, 22, 13, 9, 26, 41, DateTimeKind.Local).AddTicks(2394),
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.SiteInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("379724f2-6862-498f-8db5-2eba771e045d"),
                            About = "",
                            Activity = "LACC site",
                            Created = new DateTime(2025, 4, 22, 13, 9, 26, 41, DateTimeKind.Local).AddTicks(2201),
                            Name = "LACC"
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.SiteState", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61f49d47-b74f-4a94-8225-0095004cb93c"),
                            ClosingMessage = "The site is temporarily closed for development",
                            Created = new DateTime(2025, 4, 22, 13, 9, 26, 41, DateTimeKind.Local).AddTicks(2423),
                            State = true
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4b99c074-018e-4f27-a4dd-e02b372cc66f",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9bf6e6b2-7fd8-43c5-9e17-439a80e50481",
                            Email = "libyanlacc@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "LIBYANLACC@GMAIL.COM",
                            NormalizedUserName = "LIBYANLACC@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEHihgOYde8JRJZiAwXUGg18x/2xGtWUXAsB8lmkoVOg+TAQoJjsPvc597HWg2BbLYg==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "de196ae2-e36b-4c2c-a44b-e2e00ee9c23a",
                            TwoFactorEnabled = false,
                            UserName = "libyanlacc@gmail.com",
                            Age = 0,
                            CreatedDate = new DateTime(2025, 4, 22, 11, 9, 26, 41, DateTimeKind.Utc).AddTicks(2690)
                        });
                });
