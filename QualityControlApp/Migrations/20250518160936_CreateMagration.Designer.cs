...
namespace QualityControlApp.Migrations
{
    ...
    [Migration("20250518160936_CreateMagration")]
    partial class CreateMagration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0e04a268-2296-47dc-b190-9f4149eeef36",
                            ConcurrencyStamp = "06462af7-da1e-404b-9d8d-811395e67ce5",
                            Name = "Prog",
                            NormalizedName = "PROG"
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e36e5069-8b66-4c92-a685-cde57ea30f68"),
                            Created = new DateTime(2025, 5, 18, 18, 9, 35, 570, DateTimeKind.Local).AddTicks(7006),
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.SiteInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b76d2c4c-4679-4baf-8446-7c4e1fb0b432"),
                            About = "",
                            Activity = "LACC site",
                            Created = new DateTime(2025, 5, 18, 18, 9, 35, 570, DateTimeKind.Local).AddTicks(6806),
                            Name = "LACC"
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.SiteState", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3172a6a0-1b56-4a18-aeca-6536bed79aaf"),
                            ClosingMessage = "The site is temporarily closed for development",
                            Created = new DateTime(2025, 5, 18, 18, 9, 35, 570, DateTimeKind.Local).AddTicks(7054),
                            State = true
                        });
                });
