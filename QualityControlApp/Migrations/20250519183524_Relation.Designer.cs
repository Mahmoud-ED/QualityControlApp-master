...
namespace QualityControlApp.Migrations
{
    ...
    [Migration("20250519183524_Relation")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bbaabb43-181a-44fa-8470-96292aa1d203",
                            ConcurrencyStamp = "c6ed10f5-3273-4d15-8e64-f67f6051d579",
                            Name = "Prog",
                            NormalizedName = "PROG"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "2e9a2d79-dd2b-4b10-9d0f-2a3b7fc2646e",
                            RoleId = "bbaabb43-181a-44fa-8470-96292aa1d203"
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2752fc40-cc2e-4126-9ba3-db0c3773da2b"),
                            Created = new DateTime(2025, 5, 19, 20, 35, 22, 988, DateTimeKind.Local).AddTicks(9267),
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.SiteInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2784e687-9b70-4534-9136-fbfc787e1041"),
                            About = "",
                            Activity = "LACC site",
                            Created = new DateTime(2025, 5, 19, 20, 35, 22, 988, DateTimeKind.Local).AddTicks(9123),
                            Name = "LACC"
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.SiteState", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ccca9fbe-0b3f-4d5b-9e6d-ac027b08bbf0"),
                            ClosingMessage = "The site is temporarily closed for development",
                            Created = new DateTime(2025, 5, 19, 20, 35, 22, 988, DateTimeKind.Local).AddTicks(9301),
                            State = true
                        });
                });
            ...
            modelBuilder.Entity("QualityControlApp.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2e9a2d79-dd2b-4b10-9d0f-2a3b7fc2646e",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "140ff37b-71eb-4745-bb4c-6588eef0ca43",
                            Email = "libyanlacc@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "LIBYANLACC@GMAIL.COM",
                            NormalizedUserName = "LIBYANLACC@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAECo4Z4zl0RT9eaSwM+ttrf6K6obDb8xYPFyDmvS3UqO4m4kzGt2rqMhvcqoJFFIm4g==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "21d59da7-f75a-45eb-89e0-87f16241d66f",
                            TwoFactorEnabled = false,
                            UserName = "libyanlacc@gmail.com",
                            Age = 0,
                            CreatedDate = new DateTime(2025, 5, 19, 18, 35, 22, 988, DateTimeKind.Utc).AddTicks(9537)
                        });
                });
