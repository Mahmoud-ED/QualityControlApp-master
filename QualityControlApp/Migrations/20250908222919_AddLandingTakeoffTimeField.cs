...
{
    /// <inheritdoc />
    public partial class AddLandingTakeoffTimeField : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Normalize existing string values to numeric codes before converting column to int
